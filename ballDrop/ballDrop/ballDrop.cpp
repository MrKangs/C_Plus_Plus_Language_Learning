...
int main()
{
    int height = collectHeight();                               // Collect the Height of the building: Look at collectData.h                         
    int seconds = collectSeconds();                             // Collect the period of the ball drop: Look at collectData.h
